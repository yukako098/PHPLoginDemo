<?php
require 'config.php';   // password_verfy()はphp 5.5.0以降の関数のため、バージョンが古くて使えない場合に使用
// セッション開始
session_start();
    ...
    <body>
        ...
        <form id="loginForm" name="loginForm" action="" method="POST">
            <fieldset>
                ...
                <br>
                <label for="email">email</label><input type="email" id="email" name="email" value="" placeholder="email">
                <br>
